...
export const SIMULATION_CONFIG = {
  ...
  badges: [
    {
      id: "Respectful-Practice-Advocate",
...
export const CONTENT_PLACEHOLDERS = {
  sensitivityNotice:
    "This simulation addresses topics related to Indigenous experiences in the Canadian criminal justice system, including residential schools, intergenerational trauma, and systemic discrimination. The content is designed for educational purposes to help legal professionals develop competent practice.",
...
**Your Role:** As Eden's lawyer, you must prepare a sentencing memorandum that considers s. 718.2(e) and Gladue principles, which require courts to pay particular attention to the circumstances of Indigenous offenders.`,
  ...
  clientTranscript:
    "Eden: Thank you for meeting with me. I... I know I made a mistake. I've been trying to get clean, trying to be there for my daughter. But sometimes everything just feels too hard. My parents, they went through residential school. I never really understood what that meant until I was older. The way they were with us... they didn't know how to show love. And now I'm worried I'm doing the same thing. When I saw those messages on his phone, I just... I lost it. I know that's no excuse.",
  ...
  outcomeSummaries: {
    ...
    medium:
      "Your submission addressed some key elements, but missed opportunities to fully develop the Gladue analysis. The judge imposed a mixed sentence with some rehabilitative conditions.",
  ...
  reflectionQuestion:
    "How did your approach to representing Eden reflect your understanding of reconciliation and the legal profession's obligations to Indigenous peoples? What would you do differently in a real case?",
};
    ...
    options: [
      {
        ...
        points: 10,
        feedback:
          "Excellent. This greeting acknowledges Eden as a person, expresses appreciation, and centers her perspective. Building trust is essential in trauma-informed practice.",
      },
      {
        id: "rushed",
        ...
        points: -5,
        feedback:
          "This approach may feel transactional and dismissive. Indigenous clients, especially those with trauma histories, need time to build trust and share their stories in a culturally appropriate way.",
      },
    ],
  },
  {
    ...
    options: [
      {
        ...
        points: 10,
        feedback:
          "Well done. Acknowledging intergenerational trauma is crucial. Residential schools caused profound harm that affects subsequent generations. This is directly relevant to Gladue analysis.",
      },
      {
        id: "dismiss",
        ...
        points: -10,
        feedback:
          "This response misses a critical Gladue factor. The Supreme Court has repeatedly emphasized that courts must consider the impact of colonialism, including residential schools, on Indigenous offenders. This background is legally and ethically relevant.",
      },
    ],
  },
];
...
export const LEGAL_FACTORS: LegalFactor[] = [
  {
    ...
    rationale:
      "Residential school attendance is a key Gladue factor. The intergenerational trauma from residential schools is recognized by courts as relevant background circumstances under s. 718.2(e).",
  },
  {
    ...
    correctCategory: "gladue",
    rationale:
      "Under Gladue and Ipeelee, courts must consider how colonialism, systemic discrimination, and intergenerational trauma have affected the offender's family life, substance use, and relationships.",
  },
  {
    id: "substance-use",
    ...
    rationale:
      "While substance use in Indigenous communities may have Gladue-related roots, intoxication at the time of a violent offence is generally treated as aggravating in sentencing.",
  },
  {
    id: "weapon-use",
    ...
    correctCategory: "aggravating",
    rationale:
      "Use of a weapon causing significant injury is an aggravating factor under s. 718.2(a)(ii), increasing the seriousness of the offense.",
  },
  {
    id: "domestic-context",
    ...
    correctCategory: "aggravating",
    rationale:
      "Domestic violence is treated as an aggravating factor under s. 718.2(a)(ii), reflecting the breach of trust in intimate relationships.",
  },
  {
    id: "fled-scene",
    ...
    correctCategory: "aggravating",
    rationale:
      "Flight from the scene and from police demonstrates consciousness of guilt and lack of immediate accountability, which courts view as aggravating.",
  },
  {
    id: "prior-record",
    ...
    rationale:
      "While a prior record is generally aggravating, a significant gap demonstrates capacity for law-abiding behaviour and supports rehabilitation prospects.",
  },
  {
    id: "first-domestic",
    ...
    correctCategory: "mitigating",
    rationale:
      "The absence of a pattern of domestic abuse between the parties is a mitigating consideration in sentencing.",
  },
  {
    id: "injury-limited",
    ...
    correctCategory: "mitigating",
    rationale:
      "The absence of permanent physical harm, while still serious, is relevant to proportionality in sentencing.",
  },
  {
    id: "remorse",
    ...
    correctCategory: "mitigating",
    rationale:
      "Remorse is a general mitigating factor under s. 718 principles, showing insight and potential for rehabilitation.",
  },
  {
    ...
    correctCategory: "mitigating",
    rationale:
      "Family reconciliation and shared parental responsibilities support community-based sentencing options and reflect the Gladue principle of considering the offender's ties to community and family.",
  },
];
...
export const RUBRIC_CRITERIA: RubricCriterion[] = [
  {
    ...
    points: 10,
    feedback:
      "Successfully referenced Gladue principles in your memo to your principal, which is essential for any sentencing recommendation involving an Indigenous offender.",
  },
  {
    id: "legal-provisions",
  ...
  },
  {
    ...
    points: 10,
    feedback:
      "Demonstrated understanding of cultural and historical factors affecting Indigenous peoples in Canada in your memo.",
  },
  {
    id: "rehabilitation",
